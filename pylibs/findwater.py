...
GOOGLE_WATER_RGB_COLOR = (255,255,0) #(163,204,255)  # Google's map color as RGB tuple
# GOOGLE_I5_RGB_COLOR = (54,119,205)
# GOOGLE_HIGHWAY_RGB_COLOR = (254,217,48)
...
# zoom level
# map size
# we should be able to figure out the URL latlongs based on area, zoom level, map size
...
# if the color is present, save the image data to a file
# output a web page with each of those images 
...
parser = optparse.OptionParser(usage='%prog [options] -k <API key>  -d <data path> [-z <zoom> -o <output dir> -m <map type>]')
...
parser.add_option('-o', '--out', action="store", 
	              ...
	              help="path to a directory to store image and html output")
